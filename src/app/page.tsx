		...
		<>
			<div className="absolute left-0 top-0 h-full w-full">
				...
				<div className="left-0 top-0 mt-auto flex h-full w-full">
					<div className="card m-auto flex h-5/6 w-11/12 flex-row overflow-hidden bg-base-100 text-base-content">
						<div className="flex w-7/12 flex-col justify-between py-8 pl-14 ">
							<div className="flex flex-col justify-start gap-y-8">
								...
								<p className="w-10/12">
									Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus vestibulum nulla egestas lacus
									iaculis, commodo tempor enim posuere. Aliquam nec ante varius, pulvinar ipsum at, faucibus justo.
								</p>
						...
						<div className="flex w-5/12 pl-0">
							<div className="relative h-full w-full">
								<Image className="object-cover" fill src="/Emilia-LandingPage.jpg" alt="Emilia Landing" />
							</div>
						</div>
					</div>
				</div>
